package com.pubnub.internal.message
...
data class MessageImpl(
...
) : BaseMessage<com.pubnub.chat.Message>(
        chat = chat,
        timetoken = timetoken,
        content = content,
        channelId = channelId,
    ...
    override fun copyWithActions(actions: Actions): com.pubnub.chat.Message = copy(actions = actions)

    companion object {
        internal fun fromDTO(chat: Chat, pnMessageResult: PNMessageResult): com.pubnub.chat.Message {
            return MessageImpl(
                chat,
        ...
        internal fun fromDTO(chat: Chat, messageItem: PNFetchMessageItem, channelId: String): com.pubnub.chat.Message {

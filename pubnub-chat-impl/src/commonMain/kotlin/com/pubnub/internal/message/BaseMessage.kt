...
import com.pubnub.internal.INTERNAL_ADMIN_CHANNEL
import com.pubnub.internal.THREAD_ROOT_ID
...
abstract class BaseMessage<T : com.pubnub.chat.Message>(
    ...
    override val textLinks: List<com.pubnub.chat.types.TextLink>? get() = (meta?.get("textLinks") as? List<Any>)?.let { textLinksList: List<Any> ->

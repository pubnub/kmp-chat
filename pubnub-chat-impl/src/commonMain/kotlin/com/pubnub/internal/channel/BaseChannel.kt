package com.pubnub.internal.channel
...
import com.pubnub.internal.ChatImpl.Companion.pinMessageToChannel
import com.pubnub.internal.INTERNAL_MODERATION_PREFIX
import com.pubnub.internal.MINIMAL_TYPING_INDICATOR_TIMEOUT
import com.pubnub.internal.MembershipImpl
import com.pubnub.internal.error.PubNubErrorMessage.CHANNEL_INVITES_ARE_NOT_SUPPORTED_IN_PUBLIC_CHATS
import com.pubnub.internal.error.PubNubErrorMessage.FAILED_TO_RETRIEVE_HISTORY_DATA
import com.pubnub.internal.error.PubNubErrorMessage.MODERATION_CAN_BE_SET_ONLY_BY_CLIENT_HAVING_SECRET_KEY
import com.pubnub.internal.error.PubNubErrorMessage.TYPING_INDICATORS_NO_SUPPORTED_IN_PUBLIC_CHATS
import com.pubnub.internal.message.BaseMessage
import com.pubnub.internal.message.MessageImpl
import com.pubnub.internal.serialization.PNDataEncoder
import com.pubnub.internal.util.getPhraseToLookFor
import com.pubnub.internal.uuidFilterString

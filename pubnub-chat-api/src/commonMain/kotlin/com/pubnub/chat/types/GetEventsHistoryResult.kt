 ...
 *
 * @property events A list of [Event] objects containing [EventContent] representing the reported message events that were fetched from the history.
...
class GetEventsHistoryResult(
    val events: List<Event<EventContent>>,
    val isMore: Boolean
)
